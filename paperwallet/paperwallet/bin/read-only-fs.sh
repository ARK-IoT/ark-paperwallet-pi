...
#
#	original source: https://github.com/adafruit/Raspberry-Pi-Installer-Scripts/blob/master/read-only-fs.sh
...
echo "read/write mode, or the card must be"
echo "mounted R/W on another system."
echo
...
echo "Done. MicroSD-Card should now be read-only."
echo
